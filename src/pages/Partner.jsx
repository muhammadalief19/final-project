    ...
    <p className="text-4xl font-bold text-center mb-16">Partner</p>
        <div className="w-[90%] grid grid-rows-4 lg:grid-cols-4 lg:grid-rows-1 mx-auto items-center gap-24 py-10">
            <div className="w-full flex justify-center">
                <img src={partner1} alt="" className="w-1/2 lg:w-full grayscale hover:grayscale-0 duration-500 transition-all ease-in-out" />
            </div>
            <div className="w-full flex justify-center">
                <img src={partner2} alt="" className="w-1/2 lg:w-full grayscale hover:grayscale-0 duration-500 transition-all ease-in-out" />
            </div>
            <div className="w-full flex justify-center">
                <img src={partner3} alt="" className="w-1/2 lg:w-full grayscale hover:grayscale-0 duration-500 transition-all ease-in-out" />
                </div>
            <div className="w-full flex justify-center">
                <img src={partner4} alt="" className="w-1/2 lg:w-full grayscale hover:grayscale-0 duration-500 transition-all ease-in-out" />
            </div>
        </div>
