...
function About() {
  return (
    <>
      <div className="w-full relative px-7 py-10" id="about">
        <p className="text-4xl text-teal-600 font-bold text-center mb-5">About</p>
        <p className="w-3/4 text-justify mx-auto text-gray-600 text-lg indent-28 font-medium">
        ...
        <img src={asset1} alt="" className="absolute right-14 top-24 w-[350px] hover:translate-x-40 hover:-rotate-12 translate-y-14 transition-all duration-500  ease-in-out" />
        <img src={asset2} alt="" className="absolute -z-10 top-0 opacity-30 left-32 animate-pulse" id="mobile" />
      </div>
    </>
  );
}
